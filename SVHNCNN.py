...
__all__ = ['SVHNCNN', 'svhncnn']

model_urls = {
    'svhncnn': 'https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth',
}
...
class SVHNCNN(AlexNet):
    ...
    def __init__(self, configs):
        ...
        self.batchnorm2d1 = nn.BatchNorm2d(32, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.dropout1 = nn.Dropout(p=configs['dropout1'])
        self.dropout1.name = 'dropout1'
        layers.append(self.dropout1)

        self.conv2 = nn.Conv2d(32, 32, kernel_size=3, stride=1, padding=1)
        self.conv2.name = 'conv2'
        layers.append(self.conv2)

        self.batchnorm2d2 = nn.BatchNorm2d(32, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.dropout2 = nn.Dropout(p=configs['dropout1'])
        self.dropout2.name = 'dropout2'
        layers.append(self.dropout2)
        ...
        self.batchnorm2d3 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.dropout3 = nn.Dropout(p=configs['dropout1'])
        self.dropout3.name = 'dropout3'
        layers.append(self.dropout3)

        self.conv4 = nn.Conv2d(64, 64, kernel_size=3, stride=1, padding=1)
        self.conv4.name = 'conv4'
        layers.append(self.conv4)

        self.batchnorm2d4 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.dropout4 = nn.Dropout(p=configs['dropout1'])
        self.dropout4.name = 'dropout4'
        layers.append(self.dropout4)
        ...
        self.batchnorm2d3 = nn.BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        self.batchnorm2d3.name = 'batchnorm2d3'
        layers.append(self.batchnorm2d3)
        ...
        self.dropout5 = nn.Dropout(p=configs['dropout1'])
        self.dropout5.name = 'dropout5'
        layers.append(self.dropout5)

        self.conv6 = nn.Conv2d(128, 128, kernel_size=3, stride=1, padding=1)
        self.conv6.name = 'conv6'
        layers.append(self.conv6)

        self.batchnorm2d4 = nn.BatchNorm2d(128, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        self.batchnorm2d4.name = 'batchnorm2d4'
        layers.append(self.batchnorm2d4)
        ...
        self.dropout6 = nn.Dropout(p=configs['dropout1'])
        self.dropout6.name = 'dropout6'
        layers.append(self.dropout6)
        ...
        self.batchnorm2d5 = nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.dropout7 = nn.Dropout(p=configs['dropout1'])
        self.dropout7.name = 'dropout7'
        layers.append(self.dropout7)

        self.maxPool4 = nn.MaxPool2d(kernel_size=2, stride=2, padding=0, dilation=1, ceil_mode=False)
        self.maxPool4.name = 'maxPool4'
        layers.append(self.maxPool3)

        self.features = nn.Sequential(*layers)

        self.fc8 = nn.Linear(256, self.configs['num_classes'])
        self.fc8.name = 'fc8'
        ...
        self.grad_update = SVHNCNN.GradUpdateFunc.apply
...
def svhncnn(configs, progress=True, **kwargs):
    model = SVHNCNN(configs=configs, **kwargs)
