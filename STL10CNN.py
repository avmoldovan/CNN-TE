...
__all__ = ['STL10CNN', 'stl10cnn']

model_urls = {
    'stl10': 'https://download.pytorch.org/models/alexnet-owt-4df8aa71.pth',
}
...
class STL10CNN(AlexNet):
    ...
    def __init__(self, configs):
        ...
        self.batchnorm2d2 = nn.BatchNorm2d(64, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        self.batchnorm2d6 = nn.BatchNorm2d(256, eps=1e-05, momentum=0.1, affine=False, track_running_stats=True)
        ...
        # else:
        self.hook0 = self.conv6.weight.register_hook(self.hook0_fn)
        ...
        self.grad_update = STL10CNN.GradUpdateFunc.apply
...
def stl10cnn(configs, progress=True, **kwargs):
    model = STL10CNN(configs=configs, **kwargs)
